...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>     
 <link rel="stylesheet" href='<c:url value="/resources/css/main/dropdown.css" />' />
...
<div class="clear"></div>
<hr color="#EAEAEA">
<div id="logo"><a href='<c:url value="/main" />' ><img src='<c:url value="/resources/images/logo.png" />' width="280" height="75" alt="Fun Web"></a></div>
