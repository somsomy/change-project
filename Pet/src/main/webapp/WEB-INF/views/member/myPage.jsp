...
<script defer src='<c:url value="/resources/script/member/dupcheck.js" />'></script>
<script defer src='<c:url value="/resources/script/member/memberUpdate.js" />'></script>
</head>
<body>
...
<h3>이름 <img src='<c:url value="/resources/images/dry-clean.png" />' class="dot"></h3>
