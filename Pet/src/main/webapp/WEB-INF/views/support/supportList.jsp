...
<link href='<c:url value="/resources/css/board/supportCats.css" />' rel="stylesheet" type="text/css">
...
<c:forEach var="cb" items="${cbList }">
	<table>
	<tr><td rowspan="2" id="catimg"><img src='<c:url value="/resources/upload/uploadImage/${cb.fileRealName }" />' width="300" height="300"></td>
	<td>안녕하새오! 나는 <span id="catName">${cb.catName }</span> 이애옹.</td>
	<td><input type="button" value="고양이 정보" class="supBtn" onclick="location.href='supportContent.jsp?catId=${cb.catId}'" ></td></tr>
