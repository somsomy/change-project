...
<link href='<c:url value="/resources/css/board/support.css" />' rel="stylesheet" type="text/css">

<script defer src='<c:url value="/resources/script/support/support.js" />' ></script>
...
<table class="table1">
	<tr><td rowspan="2"><img src='<c:url value="/resources/upload/uploadImage/${cb.fileRealName }" />' width="300" height="300" ></td>
	<td>${cb.catName }</td></tr>
...
<tr><td>성함 <img src='<c:url value="/resources/images/dry-clean.png" />' class="dot"></td><td><input type="text" name="name" value="${mb.name }" required></td></tr>
<tr><td>휴대전화 <img src='<c:url value="/resources/images/dry-clean.png" />' class="dot"></td><td><input type="text" name="phone" value="${mb.phone }" required></td></tr>
<tr><td>이메일주소 <img src='<c:url value="/resources/images/dry-clean.png" />' class="dot"></td><td><input type="text" name="email" value="${mb.email }" required></td></tr>
</table>
<div id="wbtn">
