...
<script defer src='<c:url value="/resources/script/support/support2.js" />' ></script>
</head>
<body>
<div id="wrap">
...
<table class="mycats">
<tr><td colspan="2"><img src='<c:url value="/resources/upload/uploadImage/${scb.fileRealName }" />' class="mycatsImg"></td></tr>
...
<img src='<c:url value="/resources/images/dry-clean.png" />'  class="dot"> 정기후원의 경우 선택한 일에 자동이체가 됩니다.
</td>
</tr>
