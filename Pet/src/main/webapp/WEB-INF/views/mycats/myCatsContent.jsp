...
<link href='<c:url value="/resources/css/member/myCats.css" />' rel="stylesheet" type="text/css">
...
<tr><td colspan="2"><img src='<c:url value="/resources/upload/uploadImage/${scb.fileRealName }" />' width="300" height="300"></td></tr>
