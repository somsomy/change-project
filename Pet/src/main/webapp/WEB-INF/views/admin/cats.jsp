...
<link href='<c:url value="/resources/css/board/cats.css" />' rel="stylesheet" type="text/css">
</head>
<body>
...
<c:forEach var="cb" items="${cbList }">
	<div class="mycats" onclick="location.href='<c:url value="/mycats/content?num=${cb.catId}" />'">
	<div class="catImg">
	<div><img src='<c:url value="/resources/upload/uploadImage/${cb.fileRealName }" />' class="mycatsImg"></div>
