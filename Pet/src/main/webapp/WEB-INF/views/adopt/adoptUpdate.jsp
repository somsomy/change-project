...
<table id="cnotice">
<tr id="sub"><td>글제목</td><td colspan="3" ><input type="text" name="subject" id="title" value="${ab.subject }" required></td></tr>
<tr class="tdtd"><td>작성자</td><td><input type="text" name="name" value="${ab.name }" id="writer" placeholder="제목을 입력해주세요." autofocus readonly></td>
<td>고양이 이름</td><td>
