...
<link href='<c:url value="/resources/css/board/review.css" />' rel="stylesheet" type="text/css">
...
<c:forEach var="rb" items="${rbList }">
	...
	<c:choose>
		<c:when test="${!empty rb.fileRealName }">
			<img src='<c:url value="/resources/upload/uploadImage/${rb.fileRealName }" />' width="60" height="60">		
		</c:when>
		<c:otherwise>
			<img src='<c:url value="/resources/images/board/image.png" />' width="60" height="60">	
		</c:otherwise>
	</c:choose>
	</td>
